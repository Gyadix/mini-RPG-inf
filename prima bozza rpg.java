...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (scelta) {
                case 1:
                    ...
                    System.out.println("1. Arciere (support)");
                    System.out.println("2. Fante (tank, con cavallo)");
                ...
                case 2:
                    System.out.println("Inventario non ancora disponibile.");
                    break;
        ...
        if (giocoIniziato) {
            System.out.println("Buon divertimento, " + nome + "!");
        }
        }
    }
}
